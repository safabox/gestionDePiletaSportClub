namespace gestionDePiletaSportClub.Migrations
{
    ...
    public partial class clasesCovid20192020Wed : DbMigration
    {
        public override void Up()
        {

            DateTime miercoles8hs = new DateTime(2020, 12, 16, 8, 0, 0);
            DateTime miercoles9hs = new DateTime(2020, 12, 16, 9, 0, 0);
            DateTime miercoles13hs = new DateTime(2020, 12, 16, 13, 0, 0);
            DateTime miercoles18hs = new DateTime(2020, 12, 16, 18, 0, 0);
            DateTime miercoles19hs = new DateTime(2020, 12, 16, 19, 0, 0);
            ...
            for (int i = 0; i < 12; i++)
            {
                ...
                id++;
                Sql(String.Format("Insert into Actividad ( levelid,tipoActividadid,amountofenrollment,pendingenrollment,schedule,estadoActividadid,membershiptypeid) values ({0},{1},4,4,'{2}',1,3)", 6, 1, miercoles8hs.ToString("yyyy-MM-ddTHH:mm:ss")));
                id++;
                ...
                id++;
                Sql(String.Format("Insert into Actividad ( levelid,tipoActividadid,amountofenrollment,pendingenrollment,schedule,estadoActividadid,membershiptypeid) values ({0},{1},4,4,'{2}',1,3)", 4, 1, miercoles9hs.ToString("yyyy-MM-ddTHH:mm:ss")));
                id++;
                #endregion
                ...
                #region adulto18HS
                Sql(String.Format("Insert into Actividad ( levelid,tipoActividadid,amountofenrollment,pendingenrollment,schedule,estadoActividadid,membershiptypeid) values ({0},{1},4,4,'{2}',1,3)", 1, 1, miercoles18hs.ToString("yyyy-MM-ddTHH:mm:ss")));
                id++;
                Sql(String.Format("Insert into Actividad ( levelid,tipoActividadid,amountofenrollment,pendingenrollment,schedule,estadoActividadid,membershiptypeid) values ({0},{1},4,4,'{2}',1,3)", 6, 1, miercoles18hs.ToString("yyyy-MM-ddTHH:mm:ss")));
                id++;
                Sql(String.Format("Insert into Actividad ( levelid,tipoActividadid,amountofenrollment,pendingenrollment,schedule,estadoActividadid,membershiptypeid) values ({0},{1},4,4,'{2}',1,3)", 4, 1, miercoles18hs.ToString("yyyy-MM-ddTHH:mm:ss")));
                id++;
                #endregion

                #region adulto19HS
                Sql(String.Format("Insert into Actividad ( levelid,tipoActividadid,amountofenrollment,pendingenrollment,schedule,estadoActividadid,membershiptypeid) values ({0},{1},4,4,'{2}',1,3)", 1, 1, miercoles19hs.ToString("yyyy-MM-ddTHH:mm:ss")));
                id++;
