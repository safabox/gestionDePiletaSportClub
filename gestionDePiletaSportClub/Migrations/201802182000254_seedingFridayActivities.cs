    ...
    public partial class seedingFridayActivities : DbMigration
    {
        public override void Up()
        {
            ...
            for (int i = 0; i < 45; i++)
            {
                ...
                //id++;
                Sql(String.Format("Insert into Actividad ( levelid,tipoActividadid,amountofenrollment,pendingenrollment,schedule,estadoActividadid,membershiptypeid) values ({0},{1},7,7,'{2}',1,3)", 6, 1, fri9hs.ToString("yyyy-MM-ddTHH:mm:ss")));
                id++;
                ...
                //id++;
                Sql(String.Format("Insert into Actividad ( levelid,tipoActividadid,amountofenrollment,pendingenrollment,schedule,estadoActividadid,membershiptypeid) values ({0},{1},7,7,'{2}',1,3)", 6, 1, fri13hs.ToString("yyyy-MM-ddTHH:mm:ss")));
                id++;
                ...
                //id++;
                Sql(String.Format("Insert into Actividad ( levelid,tipoActividadid,amountofenrollment,pendingenrollment,schedule,estadoActividadid,membershiptypeid) values ({0},{1},7,7,'{2}',1,3)", 6, 1, fri19hs.ToString("yyyy-MM-ddTHH:mm:ss")));
                id++;
                ...
                //id++;
                Sql(String.Format("Insert into Actividad ( levelid,tipoActividadid,amountofenrollment,pendingenrollment,schedule,estadoActividadid,membershiptypeid) values ({0},{1},7,7,'{2}',1,3)", 6, 1, fri20hs.ToString("yyyy-MM-ddTHH:mm:ss")));
                id++;
