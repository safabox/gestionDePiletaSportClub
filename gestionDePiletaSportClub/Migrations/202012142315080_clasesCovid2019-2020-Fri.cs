namespace gestionDePiletaSportClub.Migrations
{
    ...
    public partial class clasesCovid20192020Fri : DbMigration
    {
        public override void Up()
        {

            DateTime viernes8hs = new DateTime(2020, 12, 18, 8, 0, 0);
            DateTime viernes9hs = new DateTime(2020, 12, 18, 9, 0, 0);
            DateTime viernes13hs = new DateTime(2020, 12, 18, 13, 0, 0);
            DateTime viernes18hs = new DateTime(2020, 12, 18, 18, 0, 0);
            DateTime viernes19hs = new DateTime(2020, 12, 18, 19, 0, 0);
            ...
            for (int i = 0; i < 12; i++)
            {
                ...
                id++;
                Sql(String.Format("Insert into Actividad ( levelid,tipoActividadid,amountofenrollment,pendingenrollment,schedule,estadoActividadid,membershiptypeid) values ({0},{1},4,4,'{2}',1,3)", 6, 1, viernes8hs.ToString("yyyy-MM-ddTHH:mm:ss")));
                id++;
                ...
                id++;
                Sql(String.Format("Insert into Actividad ( levelid,tipoActividadid,amountofenrollment,pendingenrollment,schedule,estadoActividadid,membershiptypeid) values ({0},{1},4,4,'{2}',1,3)", 4, 1, viernes9hs.ToString("yyyy-MM-ddTHH:mm:ss")));
                id++;
                #endregion
                ...
                id++;
                Sql(String.Format("Insert into Actividad ( levelid,tipoActividadid,amountofenrollment,pendingenrollment,schedule,estadoActividadid,membershiptypeid) values ({0},{1},4,4,'{2}',1,3)", 6, 1, viernes18hs.ToString("yyyy-MM-ddTHH:mm:ss")));
                id++;
